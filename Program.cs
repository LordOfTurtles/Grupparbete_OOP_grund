...
class Program
{
    static void Main(string[] args)
    {
        ...
        Hotel.Rooms[2].roomBookings.Add(new Booking(new Guest("Sandra", "12738", "078532", "hej@hej.se"), new List<Room>(), new BookingPeriod(new DateTime(2023, 12, 14, 15, 00, 00), new DateTime(2023, 12, 17, 11, 00, 00)), 0.00, 1));
